# TERMINAL BASED DUAL-BAND PENETRATION TESTING TOOL FOR WIFI NETWORKS AND WARDRIVING
...
* `HANDSHAKE CAPTURE`
* `MISC ATTACKS`<br>
ALL JUST BY USING SCAPY! WITH SUPPORT FOR BOTH 2.4 and 5 GHz networks
## IMAGES
<p float="left">
